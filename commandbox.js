...
(function() {
  var MyCommandManager, commandFixedListener, frameID, g, onRequest, opt, searchFixedListener, searchUpdatedListener, sender, _ref, _ref1, _ref2, _ref3, _ref4,
  ...
  g.CandSourceHistory = (function(_super) {
    ...
    function CandSourceHistory() {
      _ref1 = CandSourceHistory.__super__.constructor.apply(this, arguments);
      return _ref1;
    }
  ...
  g.CandSourceBookmark = (function(_super) {
    ...
    function CandSourceBookmark() {
      _ref2 = CandSourceBookmark.__super__.constructor.apply(this, arguments);
      return _ref2;
    }
  ...
  g.CandSourceGoogleSuggest = (function(_super) {
    ...
    function CandSourceGoogleSuggest() {
      _ref3 = CandSourceGoogleSuggest.__super__.constructor.apply(this, arguments);
      return _ref3;
    }
  ...
  g.CandSourceWebSuggest = (function(_super) {
    ...
    function CandSourceWebSuggest() {
      _ref4 = CandSourceWebSuggest.__super__.constructor.apply(this, arguments);
      return _ref4;
    }
  ...
  onRequest = function(req) {
    var candBox, obj, reqPrefix, src, _i, _j, _len, _len1, _ref5, _ref6, _ref7, _ref8;
    ...
    switch (req.mode) {
      case "Command":
        ...
        for (_i = 0, _len = _ref5.length; _i < _len; _i++) {
          src = _ref5[_i];
          reqPrefix = (_ref6 = src.reqPrefix) != null ? _ref6 : false;
      ...
      case "Search":
        ...
        for (_j = 0, _len1 = _ref7.length; _j < _len1; _j++) {
          src = _ref7[_j];
          reqPrefix = (_ref8 = src.reqPrefix) != null ? _ref8 : false;
          obj = (new g[src["class"]](src.num)).requirePrefix(reqPrefix);
          candBox.addSource(obj);
        }
        if (g.commandBox != null) {
