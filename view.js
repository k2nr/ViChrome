(function() {
  ...
  $.fn.extend({
    ...
    scrollTo: function(x, y, speed) {
      ...
      if (!((x != null) || (y != null))) {
        ...
        if ($(this).isWithinScreen()) return $(this);
      }
      ...
      left = x != null ? x : newX;
      top = y != null ? y : newY;
      if (!g.model.getSetting("smoothScroll")) speed = 0;
  ...
  g.Surface = (function() {
    ...
    Surface.prototype.attach = function(w) {
      if (typeof top !== "undefined" && top !== null) $('html').append(w);
      return this;
    };
    ...
    Surface.prototype.activateStatusLine = function() {
      ...
      if (this.statusLineVisible) return;
