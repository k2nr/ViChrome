...
(function() {
  ...
  g.TabHistory = (function() {
    ...
    TabHistory.prototype.setTopFrameID = function(tab, id) {
      ...
      if (((_ref1 = this.openTabs[tab.windowId]) != null ? _ref1[tab.id] : void 0) != null) {
    ...
    TabHistory.prototype.getTopFrameID = function(tab) {
      ...
      return (_ref1 = this.openTabs[tab.windowId]) != null ? (_ref2 = _ref1[tab.id]) != null ? _ref2.topFrame : void 0 : void 0;
    };
    ...
    TabHistory.prototype.getCommandBoxID = function(tab) {
      ...
      return (_ref1 = this.openTabs[tab.windowId]) != null ? (_ref2 = _ref1[tab.id]) != null ? _ref2.comBoxID : void 0 : void 0;
    };
    ...
    TabHistory.prototype.getFrames = function(tab) {
      ...
      return (_ref1 = this.openTabs[tab.windowId]) != null ? (_ref2 = _ref1[tab.id]) != null ? _ref2.frames : void 0 : void 0;
    };
        ...
        for (_i = 0, _len = wins.length; _i < _len; _i++) {
          ...
          _results.push((function() {
            ...
            for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
              tab = _ref1[_j];
              _results1.push(this.addOpenTabItem(tab));
            }
            return _results1;
          }).call(_this));
        }
    ...
    TabHistory.prototype.setupListeners = function() {
      ...
      chrome.tabs.onRemoved.addListener(function(tabId, info) {
        ...
        if (item) {
          ...
          if (_this.closeHistStack.length > 10) {
            _this.closeHistStack.shift();
          }
        }
      });
